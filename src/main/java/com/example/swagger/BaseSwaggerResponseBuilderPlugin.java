...
public class BaseSwaggerResponseBuilderPlugin implements OperationBuilderPlugin, Ordered {
    ...
    public void apply(OperationContext context) {
        ...
        ResolvedType resolvedType = isVoid(context.getReturnType()) ?
                typeResolver.resolve(Result.class) : typeResolver.resolve(Result.class, context.getReturnType());
        ...
        context.operationBuilder()
                .responses(singletonList(documentationPlugins.response(responseContext)));
    }
